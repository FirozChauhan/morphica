...
export function Signature() {
  return (
    <div className="pointer-events-none fixed bottom-4 right-4 z-40 select-none">
      <div
        dir="rtl"
        className="flex items-center border border-white/10 bg-black/50 px-3 py-1 pb-2 backdrop-blur-sm"
      >
        <span className="font-ruqaa text-1xl leading-none text-white">
          فیروز چوہان
        </span>
      </div>
    </div>
